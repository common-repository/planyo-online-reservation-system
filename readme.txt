...
Planyo is available in 30+ languages in the frontend and 6 in the backend and helps you manage your clients' bookings by handling all email communication with the clients, allowing various booking confirmation mechanisms, handling payments (also online credit card payments), printing invoices etc.
...
- Accept bookings in 30+ languages, backend in 6 languages
...
Planyo works with 6 languages in the backend (English, French, German, Spanish, Italian, Polish) and 30+ languages in the frontend.
...
= 2.7 =
* Update of the integration with the wordpress login
* If the bootstrap scheme is used, the module can include bootstrap if not present

= 2.8 =
* New languages supported (34 languages in total)
* Extra scripts included statically instead of using document.write
